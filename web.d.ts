...
declare namespace $ {
	...
	type $mol_svg_path__geometry__WKD20V0W = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__L0GV1Z4W = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__ZZLY0W0F = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__1DAR4ZZ1 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__VBUBTX2A = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__IO1RM9QR = $mol_type_enforce<
		string
		,
