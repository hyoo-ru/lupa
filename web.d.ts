...
declare namespace $ {
	...
	type $mol_svg_path__geometry__A5MA3YCU = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__LS09IOCK = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__EGQ03JTL = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__IGHDSJLY = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__RXBSQRK3 = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__THP310MH = $mol_type_enforce<
		string
		,
