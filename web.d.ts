...
declare namespace $ {
	...
	type $mol_svg_path__geometry__ISPI3RTH = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__1C3B87GK = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__S49UOGGY = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__3T88CVTT = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__OPG07SON = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__M970RGWZ = $mol_type_enforce<
		string
		,
