...
declare namespace $ {
	...
	type $mol_svg_path__geometry__M5BQDRFU = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__0AFREQ1H = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__NDXRODV3 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__YOPXCRGJ = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__G9GO0JYQ = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__E4BC702V = $mol_type_enforce<
		string
		,
