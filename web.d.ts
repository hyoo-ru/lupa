...
declare namespace $ {
	...
	type $mol_svg_path__geometry__YFWPVEMO = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__N6X2ZY2V = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__QKY3OI5W = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__VUILAIN0 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__246VU0IP = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__PBA8X51E = $mol_type_enforce<
		string
		,
