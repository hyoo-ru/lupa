...
declare namespace $ {
	...
	type $mol_svg_path__geometry__EOW7D53Z = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__XTIYTQ7Z = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__M01JY0ED = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__LWUFGYNB = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__2C1HNWCM = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__5X97UJM9 = $mol_type_enforce<
		string
		,
