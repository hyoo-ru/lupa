...
declare namespace $ {
	...
	type $mol_svg_path__geometry__D1G3VW3O = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__SNH4M7O7 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__PSGZLLUZ = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__SFQJKH5C = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__5DIE4QSX = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__453UCBHT = $mol_type_enforce<
		string
		,
