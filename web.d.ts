...
declare namespace $ {
	...
	type $mol_svg_path__geometry__EZNJ3HHZ = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__P6ME1P50 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__L7B11FCA = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__6D20MHLI = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__YR4BUW1D = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__ROP0PZ6O = $mol_type_enforce<
		string
		,
