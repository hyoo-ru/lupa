...
declare namespace $ {
	...
	type $mol_svg_path__geometry__TAFZWBBD = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__RXO7CWXV = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__56S7UDXM = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__K45E71PO = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__1Y6FB7ZR = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__76JXH2CC = $mol_type_enforce<
		string
		,
