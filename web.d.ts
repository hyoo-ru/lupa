...
declare namespace $ {
	...
	type $mol_svg_path__geometry__CAFWF3NJ = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__B79AGKRO = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__YVDCGPEQ = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__6SDKPW6L = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__UIDRREQZ = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__ZID6U8YG = $mol_type_enforce<
		string
		,
