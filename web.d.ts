...
declare namespace $ {
	...
	type $mol_svg_path__geometry__4PTTTIP3 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__7EDBECA4 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__YTZGOSHS = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__RUWQ6NGL = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__AMKDAWFZ = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__J598IDDU = $mol_type_enforce<
		string
		,
