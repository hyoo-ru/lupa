...
declare namespace $ {
	...
	type $mol_svg_path__geometry__B8JUP9OE = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__Q3LBCMH2 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__T53ZJ4A9 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__WE2A6IWK = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__6RZHNSHG = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__PNLVJE1P = $mol_type_enforce<
		string
		,
