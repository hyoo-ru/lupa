...
declare namespace $ {
	...
	type $mol_svg_path__geometry__4IIWVFJS = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__DMASYOTK = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__FFOLI1KL = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__X8YZTO5K = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__H3515SWM = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__VD1E0875 = $mol_type_enforce<
		string
		,
