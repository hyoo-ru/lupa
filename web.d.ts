...
declare namespace $ {
	...
	type $mol_svg_path__geometry__PYTMLJLG = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__6RRBQON2 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__X8Y6UZSU = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__R2HGNKA3 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__YFJ00SYG = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__YZSQFXIM = $mol_type_enforce<
		string
		,
