...
declare namespace $ {
	...
	type $mol_svg_path__geometry__QBOIV30H = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__LN5M0KU6 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__4E8CRGJV = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__0N49W801 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__XOQHOJ1L = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__CK64HM0Z = $mol_type_enforce<
		string
		,
