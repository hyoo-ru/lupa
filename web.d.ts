...
declare namespace $ {
	...
	type $mol_svg_path__geometry__BCDK6OC0 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__6FQJFXLZ = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__EOWBDKX5 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__BUUIY6XC = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__QGB84DBS = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__TPEV1CNX = $mol_type_enforce<
		string
		,
