...
declare namespace $ {
	...
	type $mol_svg_path__geometry__IA5D4EXQ = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__HSRPRJK9 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__L2XURKFF = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__JRJ9R3C0 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__LFE6GW7E = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__EYBEZ01B = $mol_type_enforce<
		string
		,
