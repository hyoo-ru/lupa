...
declare namespace $ {
	...
	type $mol_svg_path__geometry__BZ7PU8UP = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__7X6K4XB8 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__KYBSQ4NC = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__ER19S7VV = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__BX6SAEQF = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__LO04HE0T = $mol_type_enforce<
		string
		,
