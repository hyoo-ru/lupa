...
declare namespace $ {
	...
	type $mol_svg_path__geometry__ZNTCWIQW = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__LTRJTHR2 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__PZOP8VGL = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__VN1YQO5A = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__I40B11C0 = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__XALAIWS3 = $mol_type_enforce<
		string
		,
