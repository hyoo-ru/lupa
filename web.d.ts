...
declare namespace $ {
	...
	type $mol_svg_path__geometry__FC6FU1Z0 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__CJNSV2WZ = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__FFGCQTYL = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__5WP7C0EL = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__MVBXV6PN = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__OUD3CZCI = $mol_type_enforce<
		string
		,
