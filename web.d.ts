...
declare namespace $ {
	...
	type $mol_svg_path__geometry__P7UD6DSC = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__VQ8X9J3B = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__SVSUDOWN = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__15HJVEN4 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__MK3OJVGU = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__UW9DIH4W = $mol_type_enforce<
		string
		,
