...
declare namespace $ {
	...
	type $mol_svg_path__geometry__G5W2C4RV = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__S8RL74Z6 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__ACL7OERW = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__VW7MNGM0 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__HPOPW4HT = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__U1SVRC41 = $mol_type_enforce<
		string
		,
