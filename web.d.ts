...
declare namespace $ {
	...
	type $mol_svg_path__geometry__5ZF6NOAA = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__U6HZUZCL = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__WXJ203RL = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__EFBTDXVO = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__6L258RRA = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__V1CV6TGI = $mol_type_enforce<
		string
		,
