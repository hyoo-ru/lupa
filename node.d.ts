...
declare namespace $ {
	...
	type $mol_svg_path__geometry__W6QTLMHA = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__CUL9TPAM = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__7Y3HV28N = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__D3IQVU1A = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__SDZT0GZQ = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__1MI1FQLG = $mol_type_enforce<
		string
		,
