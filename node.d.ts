...
declare namespace $ {
	...
	type $mol_svg_path__geometry__0PBA240B = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__PC3HFKJP = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__QGKD22NO = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__O98MRN7G = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__VFUYU1K6 = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__KOOQ3SVB = $mol_type_enforce<
		string
		,
