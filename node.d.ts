...
declare namespace $ {
	...
	type $mol_svg_path__geometry__WSFDLZ4R = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__PBWZIQ1M = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__LRQ7RMBB = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__FVZJKAF9 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__PFG57LNV = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__WELLOGBX = $mol_type_enforce<
		string
		,
