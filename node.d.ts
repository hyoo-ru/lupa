...
declare namespace $ {
	...
	type $mol_svg_path__geometry__G8HW6G7B = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__MUO419FF = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__K87VGRMP = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__2HXSWW60 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__DBGZLW9Y = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__5W2K9QQ7 = $mol_type_enforce<
		string
		,
