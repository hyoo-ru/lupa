...
declare namespace $ {
	...
	type $mol_svg_path__geometry__GRH1FD8A = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__IH7OLCOL = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__63UU4OKN = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__A7M1XB3L = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__HUE4MJBE = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__LLCI0ACK = $mol_type_enforce<
		string
		,
