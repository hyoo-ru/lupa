...
declare namespace $ {
	...
	type $mol_svg_path__geometry__LF14NQDF = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__WICDIQWY = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__EXTFYHN4 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__K0LJIS4B = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__83ZE68NC = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__QD3UCGHK = $mol_type_enforce<
		string
		,
