...
declare namespace $ {
	...
	type $mol_svg_path__geometry__YHXEPN8F = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__NIDCQSYM = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__Z7VBZ5UK = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__U8LFC6RK = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__TRG3D3A3 = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__WLRV46ZW = $mol_type_enforce<
		string
		,
