...
declare namespace $ {
	...
	type $mol_svg_path__geometry__X1NZG2VY = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__1K34FJTY = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__ZEWFPD6W = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__YBSE6VVO = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__NIA7D9LJ = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__6IGZ14WR = $mol_type_enforce<
		string
		,
