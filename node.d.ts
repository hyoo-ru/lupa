...
declare namespace $ {
	...
	type $mol_svg_path__geometry__EJWXX7BH = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__Z394BLWH = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__J5RQ454T = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__F31HSSPY = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__03OMD27N = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__WGAD8A5R = $mol_type_enforce<
		string
		,
