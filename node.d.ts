...
declare namespace $ {
	...
	type $mol_svg_path__geometry__AXUDA20F = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__ME7P6S4T = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__30BO75VC = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__VPB866NU = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__DFG8LW3M = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__ZPB30V8Q = $mol_type_enforce<
		string
		,
