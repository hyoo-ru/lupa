...
declare namespace $ {
	...
	type $mol_svg_path__geometry__H5YNUAWD = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__N02YPYN8 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__KZ1G880Z = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__7SROT590 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__WL1LXDUM = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__4MUAGPZB = $mol_type_enforce<
		string
		,
