...
declare namespace $ {
	...
	type $mol_svg_path__geometry__9ZM7VGFR = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__9EB459LF = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__AU8NI6KG = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__F3GM2KWD = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__323FKITQ = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__D2L3W99B = $mol_type_enforce<
		string
		,
