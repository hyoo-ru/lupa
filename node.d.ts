...
declare namespace $ {
	...
	type $mol_svg_path__geometry__Y36MFXOZ = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__53G2QBBW = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__ZHYRX9GD = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__KQ9QPBX4 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__YAQK69FD = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__658X9GYZ = $mol_type_enforce<
		string
		,
