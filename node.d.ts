...
declare namespace $ {
	...
	type $mol_svg_path__geometry__RCI7IWWL = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__AG36JT8T = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__9IMWVQ06 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__KHR240K8 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__O2C2FW5K = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__BC8M0N44 = $mol_type_enforce<
		string
		,
