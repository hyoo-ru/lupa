...
declare namespace $ {
	...
	type $mol_svg_path__geometry__8JUCUCAX = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__SWGH0HZ3 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__QBG3V6HF = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__L4IP8XWZ = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__UF1UGJ4Q = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__NQLYDYJB = $mol_type_enforce<
		string
		,
