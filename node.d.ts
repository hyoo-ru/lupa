...
declare namespace $ {
	...
	type $mol_svg_path__geometry__QJCA0X4V = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__8N9YY1ME = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__TFISLIWR = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__2PRJI76O = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__N9V97SS7 = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__Z0IYEPGN = $mol_type_enforce<
		string
		,
