...
declare namespace $ {
	...
	type $mol_svg_path__geometry__V8FBIOJA = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__C1FO2S8O = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__U0FX2SN7 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__8UFXFAMS = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__I1YPCSAQ = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__SQKFY39A = $mol_type_enforce<
		string
		,
