...
declare namespace $ {
	...
	type $mol_svg_path__geometry__HL0F2EIO = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__ZE8YR83Z = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__8HECLXXP = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__G6CY6Y8T = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__T3MIG0QR = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__BONWOLJR = $mol_type_enforce<
		string
		,
