...
declare namespace $ {
	...
	type $mol_svg_path__geometry__VA6TKF8G = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__3ZG2TGJB = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__ZWWL0VPK = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__GB0CD0NC = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__37B5GZWP = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__4XHVWNIV = $mol_type_enforce<
		string
		,
