...
declare namespace $ {
	...
	type $mol_svg_path__geometry__2W9MOBVS = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__5GMSANOH = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__GTU8L8MR = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__BZ6FVBAS = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__68A3G5FT = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__F4T8KYLI = $mol_type_enforce<
		string
		,
